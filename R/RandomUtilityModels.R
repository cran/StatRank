...
#' @param Data ranking data
#' @param parameter Mean of Exponential Distribution
#' @param dist norm or norm.fixedvariance
#' @param range range
#' @param res res
#' @return log likelihood
#' @export
...
#' @param dist underlying distribution. Can be "normal", "normal.fixedvariance", "exp"
...
Estimation.Normal.GMM = function(Data.pairs, m, prior = 0)
{
  ...
  list(Mean = muhat, Parameters = convert.vector.to.list.of.means(muhat))
}
